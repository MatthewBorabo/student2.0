---
layout: base
title: Mario Player and Goomba with Hills Background
...
<script type="module">
    ...
    import Goomba from '{{site.baseurl}}/assets/js/mario/Goomba.html';
    ...
    async function setupGame() {
        try {
            ...
            const [backgroundImg, playerImg, goombaFile] = await Promise.all([
